...
#include <vector>
#include <memory>
#include "GLViewFirstABurnModule.h" //GLView subclass instantiated to drive this simulation
...
int main(int argc, char* argv[])
{
	...
	do
	{
		std::unique_ptr< Aftr::GLViewFirstABurnModule > glView(Aftr::GLViewFirstABurnModule::New(args));
